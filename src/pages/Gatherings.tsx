...
export const Gatherings: React.FC = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-cream">
      <div className="text-center p-8 max-w-2xl mx-auto">
        ...
        <p className="font-sans text-lg text-charcoal/80 mb-8 leading-relaxed">
          I am currently planning meaningful gatherings to nurture your spiritual journey in community.
          Please check back soon for updates on upcoming events and retreats!
        </p>
